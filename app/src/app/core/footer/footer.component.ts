  ...
  template: `
    <footer id="footer" class="border-t border-slate-800 py-5 shrink-0">
      <div class="max-w-4xl mx-auto px-6 flex flex-wrap items-center justify-between gap-y-3">
        ...
        <!-- Esquerda: versão -->
        <span id="footer-version" class="text-xs text-slate-600">GLA Hub — v1.2.0</span>
        ...
        <div id="footer-right" class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-4">
            ...
            <!-- Discord -->
            <div id="footer-discord-wrapper" class="relative">
              <span
                class="text-slate-600 hover:text-slate-300 transition-colors cursor-pointer"
                (click)="discordTooltipAberto.set(!discordTooltipAberto())"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <!-- Tooltip -->
              @if (discordTooltipAberto()) {
              <div id="footer-discord-tooltip" class="absolute bottom-full right-0 pb-2 flex">
...
export class FooterComponent {
  ...
  discordTooltipAberto = signal(false);
