...
@Component({
  ...
  standalone: true,
  template: `
    <footer class="border-t border-slate-800 py-5 shrink-0">
      <div class="max-w-4xl mx-auto px-6 flex items-center justify-between">

        <!-- Esquerda: créditos + redes sociais -->
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="relative group">
              ...
              <!-- Tooltip -->
              <div class="absolute bottom-full right-0 pb-2 hidden group-hover:flex">
    ...
    @if (pixModalAberto()) {
      ...
      >
        ...
        >
          ...
          <img [src]="pixQrUrl" alt="QR Code PIX" class="w-48 h-48 rounded-xl" />
          <div class="w-full flex items-center gap-2 bg-slate-800 border border-slate-700 rounded-lg px-3 py-2">
            <span class="flex-1 text-xs text-slate-300 truncate font-mono">af4535fc-c12e-47dd...</span>
            <button
              (click)="copiarPix()"
